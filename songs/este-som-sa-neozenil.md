...
2. `Ami`Ked pójdeš ty pojdzem aj ja `H7`pojdeme o`Emi`baja,
`Emi`Opýtame sa mlynára `H7`co to za no`Emi`vi`D`na.
/: `G`Kolečka se otáčajů,
`Ami`žitečko se `D`mele, mele, `H7`mele, mele,
`Emi`moja milá `Ami`sa vydává, `Emi`pojdzem `H7`na ve`Emi`selie. :/
