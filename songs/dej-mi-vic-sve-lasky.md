...
1. `Ami`Vymyslel jsem spoustu napadů, `C`aú,
co `Ami`podporujou hloupou nála`G`du, `E`aú,
`Ami`hodit klíče do kanálu, `D`sjet po zadku `Dmi`holou skálu,
`Ami`v noci chodit `E`strašit do hra`Ami`du,   `G`aú..


2. Dám si dvoje housle pod bradu, aú,
...
`Ami`má drahá, `F`dej mi víc své `C`lásky, `G`aú,
`C`já nechci skoro nic, `E`já nechci skoro nic,
`Ami`já chci jen `F`pohladit tvé `C`vlásky, `E`aú..

3. Nejlepší z těch divnejch nápadů, aú,
